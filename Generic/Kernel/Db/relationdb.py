...
class RelationDb(BaseDb):
    ...
    def deleteFromParent(self, entityObj):
        ...
        _sqlDelete = """DELETE FROM pycadrel WHERE pycad_parent_id='%s'""" % str(_entityId)
    ...
    def deleteFromChild(self, entityObj):
        ...
        """
        _entityId = entityObj.getId()
        _sqlDelete = """DELETE FROM pycadrel WHERE pycad_child_id='%s'""" % str(_entityId)
        self.makeUpdateInsert(_sqlDelete)
    ...
    def deleteRelation(self, entityObjParent, entityObjChild):
        ...
        _sqlDelete = """DELETE FROM pycadrel WHERE pycad_parent_id='%s' and pycad_child_id='%s'and """ % (str(_parentId), str(_childId))
        self.makeUpdateInsert(_sqlDelete)
    ...
    def relationExsist(self, parentId, childId):
        ...
        """
        _sqlSelect = """SELECT COUNT(*) FROM pycadrel
